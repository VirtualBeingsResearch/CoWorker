...
For security issues, follow [SECURITY.en.md](SECURITY.en.md) instead of opening a public issue.
...
- Paired pages under `docs/` use `<name>.md` for Chinese and `<name>.en.md` for English. Root
  `CONTRIBUTING.md` and `SECURITY.md` use the same convention with `.en.md` companions. Update
