...
- 用户资产本地化使用 companion 文件（`SKILL.en.md`、`PALACE.en.md`、`MODE.en.md` 或 `personality.en.md` 等身份 prose）；只覆盖约定的 prose 字段，稳定元数据保留在原文件。
- `data/thinking.md` 是模型自己维护的运行时状态，不使用本地化 companion。
