...
- **Built-in interaction entries**: File inbox/outbox, REST API, and real-time SSE/WebSocket communication. External Channels connect WeCom, Weixin Claw, Telegram, and Desktop on top, plus `coworker:` peer messaging between Coworker instances.
