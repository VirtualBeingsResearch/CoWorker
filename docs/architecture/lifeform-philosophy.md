...
1. 它对应虚拟生命的哪一种能力、经历或生存条件？
2. 它属于生命体内部、外部生存设施，还是纯粹的工程承载？
3. 它如何影响同一个 Coworker 跨时间的身份和经历连续性？
4. 它产生的是原始记录、可召回记忆、当前意图，还是外部观察？这些状态是否被混淆？
5. 并行活动如何继承身份、限制权限、汇聚结果并说明归属？
6. 我们能观察什么证据来判断它有效，又能用什么结果推翻当前假设？
7. 失败、重启、模型切换或升级之后，哪些生命状态必须保持？

如果一个工程抽象无法回答它服务于什么生命现象，它可能只是暂时的实现便利；如果一种生命
能力需要跨越现有模块边界，就应让架构随理念演化，而不是为了维护边界而削弱生命机制。
