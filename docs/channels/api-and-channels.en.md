...
a placeholder message that the reply overwrites with `edit_message_text`; a second inbound edits the
old placeholder into a short close notice and sends a new one. Groups, channels, and the Weixin Claw,
