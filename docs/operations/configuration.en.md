...
| `API__COMMUNICATION_TOKEN` | Empty (administrator-token fallback) | Bearer token for production communication; protects Desktop traffic and ordinary REST messages when set, and should be configured separately to isolate permissions |
